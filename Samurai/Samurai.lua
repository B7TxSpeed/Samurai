...
sam.lineTable = {
	...
	[GetString(SAM_AA_MAGE)] = 3, -- AA - Mage
	[GetString(SAM_SS_NAHVIINTAAS)] = 21.2, -- SS - Nahviintaas
	[GetString(SAM_KA_FALGRAVN)] = 9, -- KA - Falgravn
	[GetString(SAM_RG_BAHSEI)] = 7.7, -- RG - Bahsei
	[GetString(SAM_DSR_LY_TURLI_P1_1)] = 6.5, -- DSR - Lylanar & Turlassil - Phase 1
	[GetString(SAM_DSR_LY_TURLI_P1_2)] = 6.5, -- DSR - Lylanar & Turlassil - Phase 1
	[GetString(SAM_DSR_LY_TURLI_P1_3)] = 6.5, -- DSR - Lylanar & Turlassil - Phase 1
	[GetString(SAM_DSR_LY_TURLI_P1_4)] = 6.5, -- DSR - Lylanar & Turlassil - Phase 1
	[GetString(SAM_DSR_LY_TURLI_P1_5)] = 6.5, -- DSR - Lylanar & Turlassil - Phase 1
	[GetString(SAM_DSR_LY_TURLI_P1_6)] = 6.5, -- DSR - Lylanar & Turlassil - Phase 1
	[GetString(SAM_DSR_LY_TURLI_P1_7)] = 6.5, -- DSR - Lylanar & Turlassil - Phase 1
	[GetString(SAM_DSR_LY_TURLI_P1_8)] = 6.5, -- DSR - Lylanar & Turlassil - Phase 1
	[GetString(SAM_DSR_LY_TURLI_P1_9)] = 6.5, -- DSR - Lylanar & Turlassil - Phase 1
	[GetString(SAM_DSR_LY_TURLI_P1_10)] = 6.5, -- DSR - Lylanar & Turlassil - Phase 1
	[GetString(SAM_DSR_LY_TURLI_P2_1)] = 7, -- DSR - Lylanar & Turlassil - Phase 2
	[GetString(SAM_DSR_LY_TURLI_P2_2)] = 7, -- DSR - Lylanar & Turlassil - Phase 2
	[GetString(SAM_DSR_LY_TURLI_P2_3)] = 7, -- DSR - Lylanar & Turlassil - Phase 2
	[GetString(SAM_DSR_LY_TURLI_P2_4)] = 7, -- DSR - Lylanar & Turlassil - Phase 2
	[GetString(SAM_DSR_LY_TURLI_P2_5)] = 7, -- DSR - Lylanar & Turlassil - Phase 2
	[GetString(SAM_DSR_LY_TURLI_P2_6)] = 7, -- DSR - Lylanar & Turlassil - Phase 2
	[GetString(SAM_DSR_LY_TURLI_P2_7)] = 7, -- DSR - Lylanar & Turlassil - Phase 2
	[GetString(SAM_DSR_LY_TURLI_P2_8)] = 7, -- DSR - Lylanar & Turlassil - Phase 2
	[GetString(SAM_DSR_LY_TURLI_P2_9)] = 7, -- DSR - Lylanar & Turlassil - Phase 2
	[GetString(SAM_DSR_TALERIA)] = 24, -- DSR - Taleria
	[GetString(SAM_SE_YASEYLA)] = 8, -- SE - Yaseyla
	[GetString(SAM_SE_TWELVANE)] = 6.4, -- SE - Archwizard Twelvane
	[GetString(SAM_SE_ANSUUL)] = 13, -- SE - Ansuul Portal
